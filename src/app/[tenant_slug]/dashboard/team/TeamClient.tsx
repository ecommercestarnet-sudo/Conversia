...
export default function TeamClient({ company, initialOperators, lastStatusLog, userRole }: TeamClientProps) {
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-center items-center p-6">
        <div className="bg-white border border-slate-200 rounded-2xl p-8 max-w-md text-center shadow-sm">
          ...
          <p className="text-slate-500 text-sm mb-6">
            Você precisa ter pelo menos uma empresa cadastrada para gerenciar a equipe.
          </p>
          <button
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-800 font-sans antialiased">
        ...
        <div className="max-w-4xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-base font-bold text-slate-900">Gestão de Equipe</h1>
              </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 bg-white border border-slate-200 hover:border-red-500/30 hover:bg-red-550 hover:bg-red-50 text-slate-500 hover:text-red-600 rounded-lg transition-all flex items-center justify-center shrink-0 cursor-pointer shadow-sm"
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        {notification && (
          <div className={`mb-6 p-4 rounded-xl border text-xs font-semibold flex items-center gap-2.5 shadow-sm animate-fade-in ${
                ...
                {operators.map((op) => (
                  <div key={op.id} className="py-3.5 flex justify-between items-center gap-3 first:pt-0 last:pb-0">
                    ...
                    {isAdmin && (
                      ...
                      >
                        <Trash2 className={`w-3.5 h-3.5 ${isDeleting === op.id ? 'animate-pulse' : ''}`} />
                      </button>
                    )}
                  </div>
                ))}
